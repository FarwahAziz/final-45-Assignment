let guestlist:string[]=["Umer","fatimah","Ayesha"];
...
let invitation:string[] = guestlist.map(guest =>`dear ${guest}, youu are invited to dinner`);

console.log(invitation);

//assignment 15

let guestslist:string[]=["Umer","fatimah","Ayesha"];
